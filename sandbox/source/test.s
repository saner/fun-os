...
internal_scheme_entry:
  ...
  MOV FP, SP
  @ body start
  @ calling function test-let-2
  BL test_let_2
  MOV R1, R0
  @ call end function test-let-2
  MOV R0, R1
  @ body end
  MOV SP, FP
  LDMFD SP!, {FP}
...
test_vector:
  ...
  @ int 9 with name _var48
  MOV R5, #9
  @ tagging int, reg R5
  LSL R5, R5, #2
  ORR R5, R5, #2
  @ preparing arg _var49
  @ int 4 with name _var49
  MOV R6, #4
  @ tagging int, reg R6
  LSL R6, R6, #2
  ORR R6, R6, #2
  ...
  @ int 0 with name _var51
  MOV R6, #0
  @ tagging int, reg R6
  LSL R6, R6, #2
  ORR R6, R6, #2
  @ preparing arg _var52
  @ int 10 with name _var52
  MOV R7, #10
  @ tagging int, reg R7
  LSL R7, R7, #2
  ORR R7, R7, #2
  ...
  @ int 2 with name _var57
  MOV R5, #2
  @ tagging int, reg R5
  LSL R5, R5, #2
  ORR R5, R5, #2
  @ preparing arg _var58
  @ int 30 with name _var58
  MOV R6, #30
  @ tagging int, reg R6
  LSL R6, R6, #2
  ORR R6, R6, #2
  ...
  @ int 3 with name _var60
  MOV R5, #3
  @ tagging int, reg R5
  LSL R5, R5, #2
  ORR R5, R5, #2
  @ preparing arg _var61
  @ int 40 with name _var61
  MOV R6, #40
  @ tagging int, reg R6
  LSL R6, R6, #2
  ORR R6, R6, #2
...
internal_scheme_entry2:
  ...
  @ int 3 with name _var92
  MOV R3, #3
  @ tagging int, reg R3
  LSL R3, R3, #2
  ORR R3, R3, #2
  @ preparing arg _var93
  @ int 4 with name _var93
  MOV R4, #4
  @ tagging int, reg R4
  LSL R4, R4, #2
  ORR R4, R4, #2
  ...
  @ int 5 with name _var95
  MOV R4, #5
  @ tagging int, reg R4
  LSL R4, R4, #2
  ORR R4, R4, #2
  @ preparing arg _var96
  @ int 6 with name _var96
  MOV R5, #6
  @ tagging int, reg R5
  LSL R5, R5, #2
  ORR R5, R5, #2
...
internal_scheme_entry3:
  ...
  @ int 10 with name _var121
  MOV R3, #10
  @ tagging int, reg R3
  LSL R3, R3, #2
  ORR R3, R3, #2
  @ preparing arg _var122
  @ int 20 with name _var122
  MOV R4, #20
  @ tagging int, reg R4
  LSL R4, R4, #2
  ORR R4, R4, #2
  ...
  @ int 11 with name _var126
  MOV R4, #11
  @ tagging int, reg R4
  LSL R4, R4, #2
  ORR R4, R4, #2
  @ preparing arg _var127
  @ int 21 with name _var127
  MOV R5, #21
  @ tagging int, reg R5
  LSL R5, R5, #2
  ORR R5, R5, #2
  ...
  @ int 12 with name _var131
  MOV R5, #12
  @ tagging int, reg R5
  LSL R5, R5, #2
  ORR R5, R5, #2
  @ preparing arg _var132
  @ int 22 with name _var132
  MOV R6, #22
  @ tagging int, reg R6
  LSL R6, R6, #2
  ORR R6, R6, #2
...
.Lelse_22:
  ...
  @ int 3 with name _var181
  MOV R0, #3
  @ tagging int, reg R0
  LSL R0, R0, #2
  ORR R0, R0, #2
  @ preparing arg _var182
  @ int 2 with name _var182
  MOV R1, #2
  @ tagging int, reg R1
  LSL R1, R1, #2
  ORR R1, R1, #2
...
.Lthen_42:
  ...
  @ int 1 with name _var206
  MOV R0, #1
  @ tagging int, reg R0
  LSL R0, R0, #2
  ORR R0, R0, #2
  @ preparing arg _var207
  @ int 2 with name _var207
  MOV R1, #2
  @ tagging int, reg R1
  LSL R1, R1, #2
  ORR R1, R1, #2
...
.Lthen_54:
  @ then block
  @ int 100 with name _var220
  MOV R0, #100
  @ tagging int, reg R0
  LSL R0, R0, #2
  ORR R0, R0, #2
  @ int 30 with name _var221
  MOV R1, #30
  @ tagging int, reg R1
  LSL R1, R1, #2
  ORR R1, R1, #2
  @ int 30 with name _var222
  MOV R2, #30
  @ tagging int, reg R2
  LSL R2, R2, #2
  ORR R2, R2, #2
  @ int 30 with name _var223
  MOV R3, #30
  @ tagging int, reg R3
  LSL R3, R3, #2
  ORR R3, R3, #2
  @ int 30 with name _var224
  MOV R4, #30
  @ tagging int, reg R4
  LSL R4, R4, #2
  ORR R4, R4, #2
  @ int 30 with name _var225
  MOV R5, #30
  @ tagging int, reg R5
  LSL R5, R5, #2
  ORR R5, R5, #2
