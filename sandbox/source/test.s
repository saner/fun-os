...
test_vector_init:
  ...
  @ int 99 with name _var146
  MOV R2, #99
  @ tagging int, reg R2
  LSL R2, R2, #3
  ORR R2, R2, #2
  @ preparing arg _var147
  @ int 9 with name _var147
  MOV R3, #9
  @ tagging int, reg R3
  LSL R3, R3, #3
  ORR R3, R3, #2
...
test_vector:
  ...
  @ int 6 with name _var154
  MOV R4, #6
  @ tagging int, reg R4
  LSL R4, R4, #3
  ORR R4, R4, #2
  @ preparing arg _var155
  @ int 1 with name _var155
  MOV R5, #1
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  ...
  @ int 7 with name _var157
  MOV R4, #7
  @ tagging int, reg R4
  LSL R4, R4, #3
  ORR R4, R4, #2
  @ preparing arg _var158
  @ int 2 with name _var158
  MOV R5, #2
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  ...
  @ int 8 with name _var160
  MOV R5, #8
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  @ preparing arg _var161
  @ int 3 with name _var161
  MOV R6, #3
  @ tagging int, reg R6
  LSL R6, R6, #3
  ORR R6, R6, #2
  ...
  @ int 9 with name _var163
  MOV R5, #9
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  @ preparing arg _var164
  @ int 4 with name _var164
  MOV R6, #4
  @ tagging int, reg R6
  LSL R6, R6, #3
  ORR R6, R6, #2
  ...
  @ int 0 with name _var166
  MOV R6, #0
  @ tagging int, reg R6
  LSL R6, R6, #3
  ORR R6, R6, #2
  @ preparing arg _var167
  @ int 10 with name _var167
  MOV R7, #10
  @ tagging int, reg R7
  LSL R7, R7, #3
  ORR R7, R7, #2
  ...
  @ int 2 with name _var172
  MOV R5, #2
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  @ preparing arg _var173
  @ int 30 with name _var173
  MOV R6, #30
  @ tagging int, reg R6
  LSL R6, R6, #3
  ORR R6, R6, #2
  ...
  @ int 3 with name _var175
  MOV R5, #3
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  @ preparing arg _var176
  @ int 40 with name _var176
  MOV R6, #40
  @ tagging int, reg R6
  LSL R6, R6, #3
  ORR R6, R6, #2
...
test_cons_init:
  ...
  @ int 1 with name _var204
  MOV R0, #1
  @ tagging int, reg R0
  LSL R0, R0, #3
  ORR R0, R0, #2
  @ preparing arg _var205
  @ int 2 with name _var205
  MOV R1, #2
  @ tagging int, reg R1
  LSL R1, R1, #3
  ORR R1, R1, #2
  ...
  @ int 3 with name _var207
  MOV R3, #3
  @ tagging int, reg R3
  LSL R3, R3, #3
  ORR R3, R3, #2
  @ preparing arg _var208
  @ int 4 with name _var208
  MOV R4, #4
  @ tagging int, reg R4
  LSL R4, R4, #3
  ORR R4, R4, #2
  ...
  @ int 5 with name _var210
  MOV R4, #5
  @ tagging int, reg R4
  LSL R4, R4, #3
  ORR R4, R4, #2
  @ preparing arg _var211
  @ int 6 with name _var211
  MOV R5, #6
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  ...
  LDMFD SP!, {R0, R1, R2, R3}
  @ call end function cons
  @ preparing arg _var215
  @ calling function cons
  @ preparing arg _var213
  @ int 7 with name _var213
  MOV R5, #7
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  @ preparing arg _var214
  @ int 8 with name _var214
  MOV R6, #8
  @ tagging int, reg R6
  LSL R6, R6, #3
  ORR R6, R6, #2
...
test_cons_2_init:
  ...
  @ int 1 with name _var233
  MOV R0, #1
  @ tagging int, reg R0
  LSL R0, R0, #3
  ORR R0, R0, #2
  @ preparing arg _var234
  @ int 2 with name _var234
  MOV R1, #2
  @ tagging int, reg R1
  LSL R1, R1, #3
  ORR R1, R1, #2
  ...
  @ int 10 with name _var238
  MOV R3, #10
  @ tagging int, reg R3
  LSL R3, R3, #3
  ORR R3, R3, #2
  @ preparing arg _var239
  @ int 20 with name _var239
  MOV R4, #20
  @ tagging int, reg R4
  LSL R4, R4, #3
  ORR R4, R4, #2
  ...
  @ int 11 with name _var243
  MOV R4, #11
  @ tagging int, reg R4
  LSL R4, R4, #3
  ORR R4, R4, #2
  @ preparing arg _var244
  @ int 21 with name _var244
  MOV R5, #21
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  ...
  @ int 12 with name _var248
  MOV R5, #12
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  @ preparing arg _var249
  @ int 22 with name _var249
  MOV R6, #22
  @ tagging int, reg R6
  LSL R6, R6, #3
  ORR R6, R6, #2
  ...
  @ int 13 with name _var253
  MOV R5, #13
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  @ preparing arg _var254
  @ int 23 with name _var254
  MOV R6, #23
  @ tagging int, reg R6
  LSL R6, R6, #3
  ORR R6, R6, #2
  ...
  @ int 5 with name _var258
  MOV R5, #5
  @ tagging int, reg R5
  LSL R5, R5, #3
  ORR R5, R5, #2
  @ preparing arg _var259
  @ int 6 with name _var259
  MOV R6, #6
  @ tagging int, reg R6
  LSL R6, R6, #3
  ORR R6, R6, #2
...
.Lelse_10:
  ...
  @ call end function print_int_c_wrapper
  @ calling function power
  @ preparing arg _var281
  @ int 1 with name _var280
  MOV R2, #1
  @ tagging int, reg R2
  LSL R2, R2, #3
  ORR R2, R2, #2
...
.Lelse_16:
  ...
  LDR R0, [FP, #-4]
  @ calling function power
  @ preparing arg _var290
  @ int 1 with name _var289
  MOV R1, #1
  @ tagging int, reg R1
  LSL R1, R1, #3
  ORR R1, R1, #2
...
scheme_entry2:
  ...
  @ calculating predicate
  @  -- comp LT -- 
  @ int 2 with name _var293
  MOV R0, #2
  @ tagging int, reg R0
  LSL R0, R0, #3
  ORR R0, R0, #2
  @ int 1 with name _var294
  MOV R1, #1
  @ tagging int, reg R1
  LSL R1, R1, #3
  ORR R1, R1, #2
...
.Lelse_22:
  ...
  @ int 3 with name _var298
  MOV R0, #3
  @ tagging int, reg R0
  LSL R0, R0, #3
  ORR R0, R0, #2
  @ preparing arg _var299
  @ int 2 with name _var299
  MOV R1, #2
  @ tagging int, reg R1
  LSL R1, R1, #3
  ORR R1, R1, #2
...
.Lelse_25:
  ...
  @ preparing arg _var303
  @ bool False with name _var303
  MOV R0, #0
  @ tagging bool, reg R0
  LSL R0, R0, #3
  ORR R0, R0, #4
...
.Lthen_39:
  ...
  @ preparing arg _var319
  @ int 1 with name _var319
  MOV R0, #1
  @ tagging int, reg R0
  LSL R0, R0, #3
  ORR R0, R0, #2
...
.Lthen_42:
  ...
  @ int 1 with name _var323
  MOV R0, #1
  @ tagging int, reg R0
  LSL R0, R0, #3
  ORR R0, R0, #2
  @ preparing arg _var324
  @ int 2 with name _var324
  MOV R1, #2
  @ tagging int, reg R1
  LSL R1, R1, #3
  ORR R1, R1, #2
...
.Lthen_45:
  @ then block
  @ calling function print_bool
  @ preparing arg _var328
  @ bool True with name _var328
  MOV R0, #1
  @ tagging bool, reg R0
  LSL R0, R0, #3
  ORR R0, R0, #4
